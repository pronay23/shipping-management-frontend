...
import { downloadIgmXml } from "../../manifest/api/generateManifestXml";

export default function IgmCreatePage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      await downloadIgmXml(selectedVoyageId);
    } catch (e) {
      console.error(e);
    } finally {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="font-mono text-xs text-[#B9C6D6]">
                Select a Voyage to generate the Import General Manifest XML
              </p>
            </div>
          </div>
        </div>
